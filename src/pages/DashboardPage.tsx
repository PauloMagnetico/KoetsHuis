...
export default function DashboardPage() {
  ...
  // Union of all categories across all three datasets
  ...
  return (
    <div className="page">
      ...
      {loading ? <p>Loading...</p> : !hasAnyData ? (
        <p style={{ color: '#888', marginTop: '2rem' }}>No data yet — add estimates, invoices or expenses first.</p>
      ) : (
        <>
